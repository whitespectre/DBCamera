Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://github.com/danielebogo/DBCamera.git', :tag => '2.3.15' }
  s.platform = :ios, '6.0'
  s.requires_arc = true
  ...
  s.resources = ['DBCamera/Resources/*.{xib,xcassets}', 'DBCamera/Localizations/**', 'DBCamera/Filters/*.{acv}','DBCamera/Resources/DBCameraBundle.bundle']
